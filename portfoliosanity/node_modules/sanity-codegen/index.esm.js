function createClient({
  ...
  async function query(query) {
    ...
    const response = await jsonFetch(`https://${projectId}.${useCdn ? 'apicdn' : 'api'}.sanity.io/v${normalizedApiVersion}/data/query/${dataset}?${searchParams.toString()}`, Object.assign({}, token && !useCdn && {
      headers: {
